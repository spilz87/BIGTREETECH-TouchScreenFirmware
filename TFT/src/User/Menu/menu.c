...
{
  switch (status){
    case STATUS_IDLE      : GUI_SetColor(BLUE); break;
    case STATUS_BUSY      : GUI_SetColor(YELLOW); break;
    case STATUS_UNCONNECT : GUI_SetColor(RED); break;
    case STATUS_NORMAL    : GUI_SetColor(GREEN); break;
  }
